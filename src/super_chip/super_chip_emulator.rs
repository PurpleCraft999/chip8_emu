use crate::{
    chip8::chip8_emulator::CHIP8_SCREEN_SIZE, emulator::Chip, super_chip::SuperChipOpcode,
};
...
impl Chip for SuperChipEmulator {
    ...
    fn new() -> Self {
        Self {
            display: vec![0; CHIP8_SCREEN_SIZE],
        }
    }
}

pub const SUPER_CHIP_LARGE_SCREEN_SIZE: usize = 8192;
